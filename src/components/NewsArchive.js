...
const NewsArchive = () => {
    ...
    return (
        <Box sx={{ textAlign: 'center', padding: '20px', height: '100vh', overflowY: 'scroll' }}>
            <Typography variant="h2" sx={{ marginBottom: '20px', color: '#413110' }}>
                News Archive
            </Typography>
            ...
            {selectedYear !== null && selectedMonth !== null && (
                <Box sx={{ marginTop: '20px' }}>
                    <Typography variant="h4" sx={{ marginBottom: '20px', color: '#413110' }}>
    ...
    sx={{
        ...
        '&:hover': {
            ...
            boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)',
            backgroundColor: '#34270a', // Slightly darker shade for hover effect
        },
    }}
    onClick={() => {
